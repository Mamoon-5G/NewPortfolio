...
export const Hero = () => {
    return (
        <section className="relative min-h-screen flex items-center overflow-hidden">
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-4">
                            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight animate-fade-in delay-100">
                        ...
                        <div className="flex flex-wrap gap-4 animate-fade-in delay-400">
                            <a href="#contact">
                                <Button size="lg" className="animate-fade-in delay-500">
                        ...
                        <div className="flex items-center gap-4 animate-fade-in delay-500">
                            ...
                            {[
                                ...
                                <a key={index} href={social.href} target="_blank" rel="noopener noreferrer" className="text-muted-foreground transition-colors p-2 rounded-full glass hover:bg-primary/10 hover:text-primary duration-300">
                    ...
                    <div className="relative animate-fade-in delay-300">
                        ...
                        <div className="relative max-w-md mx-auto">
                            ...
                            {/* Stats Badge */}
                            <div className="absolute -top-4 -left-4 glass rounded-xl px-4 py-2 animate-float delay-500">
                    ...
                    <div className="relative overflow-hidden">
                        <div className="flex animate-marquee">
                            {[...skills, ...skills].map((skill, index) => (
                                // <div key={index} className="px-4 py-2 bg-primary/10 text-primary rounded-full text-sm font-medium mx-2 whitespace-nowrap">
                                //     <span>{skill}</span>
                                // </div>
                                <div key={index} className="shrink-0 px-8 py-4">
                                    <span className="text-xl font-semibold text-muted-foreground/50 hover:text-muted-foreground transition-colors duration-300">{skill}</span>
                                </div>
                            ))}
                        </div>
                    </div>
            ...
            <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 animate-fade-in delay-700">
