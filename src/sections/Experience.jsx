        ...
        <section id="experience" className="py-32 relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="text-center mb-16 mx-auto max-w-3xl">
                    ...
                    <h2 className="text-4xl md:text-5xl font-bold text-secondary-foreground mt-4 mb-4 animate-fade-in delay-100">Experience that
                        <span
                                ...
                                <div className={`pl-8 md:pl-0 ${index % 2 === 0 ? "md:pr-16 md:text-right" : "md:col-start-2 md:pl-16"}`}>
                                    <div className={`glass p-6 rounded-2xl border border-primary/30 hover:border-primary/50 transition-all duration-500`}>
                                        ...
                                        <div className={`flex flex-wrap gap-2 mt-4 ${index % 2 === 0 ? "md:justify-end" : ""}`}>{exp.technologies.map((tech, techIdx) => (
                                            <span key={techIdx} className="inline-block bg-primary/10 text-muted-foreground px-3 py-1 rounded-full text-sm mr-2 mb-2">{tech}</span>
                                        ))}</div>
                                    </div>
                                </div>
                            </div>
