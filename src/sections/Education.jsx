        ...
        <section id="education" className="py-32 relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="text-center mb-16 mx-auto max-w-3xl">
                    <span className="text-secondary-foreground text-sm font-medium tracking-wider uppercase animate-fade-in-up">Academic Journey</span>
                    <h2 className="text-4xl md:text-5xl font-bold text-secondary-foreground mt-4 mb-4 animate-fade-in-up delay-200">Education that
                        <span
